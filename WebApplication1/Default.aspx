                        ...
                        <div class="block wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <section class="cd-intro">
                                ...
                                <h2 class="wow fadeInUp animated" data-wow-delay=".6s" >
                                    Welcome to CMCC's Certification Website!<br>
                                    Here you will find all the relevant materials and documentation needed for your certification process
                                </h2>
            ...
            <section id="works" class="works">
                <div class="container">
                    <div class="section-heading">
                        <h1 class="title wow fadeInDown" data-wow-delay=".3s">Certification Materials</h1>
                        <p class="wow fadeInDown" data-wow-delay=".5s">
                            Below you can find links to relevant certification materials and operations<br>
                        </p>
                    </div>
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <figure class="wow fadeInLeft animated portfolio-item" data-wow-duration="500ms" data-wow-delay="0ms">
                                <div class="img-wrapper">
                                    ...
                                    <img src="images/portfolio/item-1.jpg" class="img-responsive" alt="My Certification" >                                    
                                    <div class="overlay">
                                    </div>
                                    </a>
                                </div>
            ...
            <section id="call-to-action">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="block">
                                <h2 class="title wow fadeInDown" data-wow-delay=".3s" data-wow-duration="500ms">ANY QUESTIONS ?</h1>
                                <p class="wow fadeInDown" data-wow-delay=".5s" data-wow-duration="500ms">Please contact CMCC@Intel.com</p>
